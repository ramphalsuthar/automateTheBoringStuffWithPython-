...
#for dictionaries the order does not matter
#but forlist the order does matter

#dictionaries have the key value pair

#can check if the key is in dictionary or not by in and not in
#list(dictionaryName.keys())
#list(dictionaryName.values())
#list(dictionaryName.items())

#get method take two arguments
#eggs.get(4, 0)

#opposite of the get method is setdeault
...
#use p print module to get the pprint function
